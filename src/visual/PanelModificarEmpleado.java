...
public class PanelModificarEmpleado extends JPanel {
	...
	public PanelModificarEmpleado() {
		...
		btnModificarEmpleado.setBounds(204, 648, 141, 46);
		add(btnModificarEmpleado);
		
		JLabel lblModificarEmpleado = new JLabel("Modificar Empleado");
		lblModificarEmpleado.setFont(new Font("Arial", Font.BOLD, 22));
		lblModificarEmpleado.setBounds(17, 6, 234, 34);
		add(lblModificarEmpleado);
