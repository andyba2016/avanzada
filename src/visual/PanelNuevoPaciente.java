...
public class PanelNuevoPaciente extends JPanel {
	...
	public PanelNuevoPaciente() {
		...
		JLabel lblDatosPaciente = new JLabel("Datos del Paciente");
		lblDatosPaciente.setFont(new Font("Arial", Font.BOLD, 22));
		lblDatosPaciente.setBounds(17, 6, 234, 34);
