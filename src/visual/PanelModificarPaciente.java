...
public class PanelModificarPaciente extends JPanel {
	...
	public PanelModificarPaciente() {
		...
		JButton btnGuardarEmpleado = new JButton("Modificar");
		...
		lblModificarPaciente.setFont(new Font("Arial", Font.BOLD, 22));
		lblModificarPaciente.setBounds(17, 6, 234, 34);
		add(lblModificarPaciente);
